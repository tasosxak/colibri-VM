...
public:
    ...
    static void generate(CNIEnv* env, Method* meth, vs_stack<symbol>* st) {
        ...
        const std::string ex_command = "g++ -fPIC " + filename + " -c " + "libwrapper_" + (meth->getClass())->getName() + "_" + meth->getName() + meth->get_rtype() + ".cpp";
        std::cout << ex_command.c_str() << endl;
        system(ex_command.c_str());
        system(("g++ -shared Field.cpp Class.cpp Literal.cpp cni.cpp Integer.cpp Data_Type.cpp Numeric.cpp Primitive.cpp symbol.cpp Object.cpp Int.cpp CNIHandlerBlock.cpp -fPIC -o libwrapper_" + (meth->getClass())->getName() + "_" + meth->getName() + meth->get_rtype() + ".so " + "libwrapper_" + (meth->getClass())->getName() + "_" + meth->getName() + meth->get_rtype() + ".cpp").c_str());

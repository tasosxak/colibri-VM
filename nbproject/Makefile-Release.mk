...
${OBJECTDIR}/Accessible.o: Accessible.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Accessible.o Accessible.cpp

${OBJECTDIR}/Allocated_Object.o: Allocated_Object.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Allocated_Object.o Allocated_Object.cpp
...
${OBJECTDIR}/ArrayReference.o: ArrayReference.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArrayReference.o ArrayReference.cpp

${OBJECTDIR}/CNIHandlerBlock.o: CNIHandlerBlock.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CNIHandlerBlock.o CNIHandlerBlock.cpp

${OBJECTDIR}/CVM.o: CVM.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CVM.o CVM.cpp

${OBJECTDIR}/CallableNativeFunction.o: CallableNativeFunction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CallableNativeFunction.o CallableNativeFunction.cpp
...
${OBJECTDIR}/Data_Type.o: Data_Type.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Data_Type.o Data_Type.cpp
...
${OBJECTDIR}/Int.o: Int.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Int.o Int.cpp
...
${OBJECTDIR}/Library.o: Library.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Library.o Library.cpp

${OBJECTDIR}/Literal.o: Literal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Literal.o Literal.cpp

${OBJECTDIR}/Memory_Manager.o: Memory_Manager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Memory_Manager.o Memory_Manager.cpp
...
${OBJECTDIR}/Native_Method_Signature.o: Native_Method_Signature.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Native_Method_Signature.o Native_Method_Signature.cpp

${OBJECTDIR}/Numeric.o: Numeric.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Numeric.o Numeric.cpp
...
${OBJECTDIR}/Primitive.o: Primitive.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Primitive.o Primitive.cpp
...
${OBJECTDIR}/cni.o: cni.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cni.o cni.cpp

${OBJECTDIR}/hash_table.o: hash_table.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hash_table.o hash_table.cpp
